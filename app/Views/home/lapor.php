    ...
    <div class="container">
      <nav class="navbar-nav-wrap">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="btn btn-primary btn-sm" href="./">Kembali</a>                         
            </div>
            </li>
          </ul>
        <!-- End Collapse -->
      ...
      <div class="container content-space-2">
        <div class="row justify-content-lg-between align-items-md-center">
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <!-- Links -->
            <div class="mb-4">
              <h3><font color="#FFFFFF">Laporkan tindakan pencurian, suap, gratifikasi, korupsi, penyalahgunaan wewenang, benturan kepentingan, pelecehan, kekerasan.</font></h3>
            </div>
            <div class="d-flex mb-10">
              <p class="text-nowrap"><font color="#FFFFFF"> </font></p>
				      <p class="text-nowrap"><font color="#FFFFFF">&nbsp;<em><strong> </strong></em></font> </p>
            </div>
             <!--End Links -->
          </div>
          <!-- End Col -->
         ...
         <form action="<?= site_url('/save') ?>" method="POST" enctype="multipart/form-data">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="row mb-4">
                    <label for="phone" class="col-sm-3 col-form-label form-label">No Telepon </label>
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="row mb-4">
                    <div class="col-sm-3">
                      <span class="col-sm-3 col-form-label form-label"><font style="color: #000000; font-weight: bold;"><em>What </em>- </font>Tindakan/perbuatan yang dilaporkan <font color="#FF0509">*</font></span>
                    </div>
                    ...
                    <div class="col-sm-9">
                      ...
                      <div class="tom-select-custom">
                        <select class="js-select form-select" id="jenisPelanggaran" name="jenisPelanggaran">
                          <option value="Pencurian" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Pencurian</span><span class="tom-select-custom-hide small">Pencurian adalah Tindakan mengambil atau mengambil alih milik orang lain tanpa izin atau tanpa hak. Ini bisa melibatkan barang-barang fisik, seperti uang atau barang berharga, atau bahkan informasi atau data.</span></div></div>'>Fraud
                          </option>
                          <option value="Suap" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Suap</span><span class="tom-select-custom-hide small">Suap adalah Memberikan atau menerima sesuatu yang bernilai sebagai imbalan untuk mempengaruhi tindakan atau keputusan seseorang dalam posisi otoritas atau kekuasaan, terutama dalam konteks penyalahgunaan kekuasaan publik.</span></div></div>'>Pelanggaran Kode Etik
                          </option>
                          <option value="Gratifikasi" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.3" d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM12 7C10.3 7 9 8.3 9 10C9 11.7 10.3 13 12 13C13.7 13 15 11.7 15 10C15 8.3 13.7 7 12 7Z" fill="#035A4B"/>
                          <path d="M12 22C14.6 22 17 21 18.7 19.4C17.9 16.9 15.2 15 12 15C8.8 15 6.09999 16.9 5.29999 19.4C6.99999 21 9.4 22 12 22Z" fill="#035A4B"/>
                          </svg>
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Gratifikasi</span><span class="tom-select-custom-hide small">Gratifikasi adalah Serupa dengan suap, gratifikasi adalah memberikan atau menerima sesuatu yang bernilai sebagai hadiah atau imbalan atas tindakan tertentu atau pengaruh yang dimiliki oleh penerima hadiah.</span></div></div>'>Pelanggaran Benturan Kepentingan
                          </option>
                          <option value="Korupsi" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.3" d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM12 7C10.3 7 9 8.3 9 10C9 11.7 10.3 13 12 13C13.7 13 15 11.7 15 10C15 8.3 13.7 7 12 7Z" fill="#035A4B"/>
                          <path d="M12 22C14.6 22 17 21 18.7 19.4C17.9 16.9 15.2 15 12 15C8.8 15 6.09999 16.9 5.29999 19.4C6.99999 21 9.4 22 12 22Z" fill="#035A4B"/>
                          </svg>
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Korupsi</span><span class="tom-select-custom-hide small">Korupsi adalah Penyalahgunaan kekuasaan publik untuk keuntungan pribadi, biasanya dengan cara-cara seperti suap, gratifikasi, atau tindakan-tindakan yang merugikan kepentingan umum.</span></div></div>'>Pelanggaran Hukum
                          </option>
                          <option value="Penyalahgunaan Wewenang" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.3" d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM12 7C10.3 7 9 8.3 9 10C9 11.7 10.3 13 12 13C13.7 13 15 11.7 15 10C15 8.3 13.7 7 12 7Z" fill="#035A4B"/>
                          <path d="M12 22C14.6 22 17 21 18.7 19.4C17.9 16.9 15.2 15 12 15C8.8 15 6.09999 16.9 5.29999 19.4C6.99999 21 9.4 22 12 22Z" fill="#035A4B"/>
                          </svg>
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Penyalahgunaan Wewenang</span><span class="tom-select-custom-hide small">Penyalahgunaan Wewenang adalah Menggunakan kekuasaan atau kewenangan yang dimiliki seseorang atau sebuah badan untuk tujuan yang bertentangan dengan hukum atau norma etika, seringkali dengan merugikan pihak lain.</span></div></div>'>Pelanggaran Hukum
                          </option>
                          <option value="Benturan Kepentingan" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.3" d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM12 7C10.3 7 9 8.3 9 10C9 11.7 10.3 13 12 13C13.7 13 15 11.7 15 10C15 8.3 13.7 7 12 7Z" fill="#035A4B"/>
                          <path d="M12 22C14.6 22 17 21 18.7 19.4C17.9 16.9 15.2 15 12 15C8.8 15 6.09999 16.9 5.29999 19.4C6.99999 21 9.4 22 12 22Z" fill="#035A4B"/>
                          </svg>
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Benturan Kepentingan</span><span class="tom-select-custom-hide small">Benturan Kepentingan adalah Terjadi ketika seseorang atau sebuah badan memiliki kepentingan pribadi yang bersaing atau bertentangan dengan kepentingan yang mereka harus wakili, seperti dalam konteks pengambilan keputusan di sektor publik atau swasta.</span></div></div>'>Pelanggaran Hukum
                          </option>
                          <option value="Pelecehan" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.3" d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM12 7C10.3 7 9 8.3 9 10C9 11.7 10.3 13 12 13C13.7 13 15 11.7 15 10C15 8.3 13.7 7 12 7Z" fill="#035A4B"/>
                          <path d="M12 22C14.6 22 17 21 18.7 19.4C17.9 16.9 15.2 15 12 15C8.8 15 6.09999 16.9 5.29999 19.4C6.99999 21 9.4 22 12 22Z" fill="#035A4B"/>
                          </svg>
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Pelecehan</span><span class="tom-select-custom-hide small">Pelecehan adalah Tindakan atau perilaku yang tidak pantas atau merugikan terhadap seseorang secara fisik, emosional, atau psikologis. Ini bisa termasuk pelecehan seksual, pelecehan verbal, atau pelecehan kekuasaan.</span></div></div>'>Pelanggaran Hukum
                          </option>
                          <option value="Kekerasan" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path opacity="0.3" d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM12 7C10.3 7 9 8.3 9 10C9 11.7 10.3 13 12 13C13.7 13 15 11.7 15 10C15 8.3 13.7 7 12 7Z" fill="#035A4B"/>
                          <path d="M12 22C14.6 22 17 21 18.7 19.4C17.9 16.9 15.2 15 12 15C8.8 15 6.09999 16.9 5.29999 19.4C6.99999 21 9.4 22 12 22Z" fill="#035A4B"/>
                          </svg>
                          </span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semibold">Kekerasan</span><span class="tom-select-custom-hide small">Kekerasan adalah Penggunaan kekuatan fisik atau ancaman kekerasan untuk mencapai tujuan tertentu, seringkali dengan tujuan untuk mengontrol atau menyakiti orang lain. Ini bisa dalam bentuk kekerasan fisik langsung atau ancaman kekerasan yang tersirat.</span></div></div>'>Pelanggaran Hukum
                          </option>
                        </select>
                      </div>
                      <!-- End Select -->
                  ...
                  <div class="row mb-4">
                    <label class="col-sm-3 col-form-label form-label"><font style="color: #000000; font-weight: bold;"><em>Who </em>- </font>Nama Terlapor <font color="#FF0509">*</font></label>
                  ...
                  <div class="row mb-4">
                    <label class="col-sm-3 col-form-label form-label">Nama Divisi & Departemen </label>
                  ...
                  <div class="row mb-4">
                    <label for="waktu" class="col-sm-3 col-form-label form-label"><font style="color: #000000; font-weight: bold;"><em>When </em>- </font>Waktu Kegiatan (tanggal dan Periode) <font color="#FF0509">*</font></label>
                  ...
                  <div class="row mb-4">
                    <label for="lokasi" class="col-sm-3 col-form-label form-label"><font style="color: #000000; font-weight: bold;"><em>Where </em>- </font>Lokasi Kejadian <font color="#FF0509">*</font></label>
                  ...
                  <div class="row mb-4">
                    <label for="kronologi" class="col-sm-3 col-form-label form-label"><font style="color: #000000; font-weight: bold;"><em>Why, How </em>- </font>Kronologi Kejadian<font color="#FF0509">*</font></label>
                    <div class="col-sm-9">
...
<div class="row mb-4">
    <label for="dokumen" class="col-sm-3 col-form-label form-label">Dokumen Pendukung Lainnya (Upload Multiple File)</label>
    <div class="col-sm-9" id="dokumenContainer">
        <div class="input-group mb-2">
            <input type="file" name="dokumen[]" id="dokumen" class="form-control" multiple>
            <div class="input-group-append">
                <button id="addFileBtn" class="btn btn-primary" type="button">+</button>
            </div>
        </div>
    </div>
</div>
                  ...
                  <div class="row mb-4">
                    <label for="nominalKerugian" class="col-sm-3 col-form-label form-label">Nilai Material</label>
                  ...
                  <div class="row mb-4">
                      <label for="cerita" class="col-sm-3 col-form-label form-label">Apakah Pelaporan Ini Pernah Anda Ceritakan Pada Orang / Pihak Lainnya  <font color="#FF0509">*</font></label>

                      <div class="col-sm-9">
                          <div class="input-group input-group-md-down-break">
                              <!-- Radio Check -->
                              <label class="form-control" for="cerita_ya">
                                  <span class="form-check">
                                      <input type="radio" class="form-check-input" name="cerita" id="cerita_ya" value="Ya">
                              ...
                              <!-- Radio Check -->
                              <label class="form-control" for="cerita_tidak">
                                  <span class="form-check">
                                      <input type="radio" class="form-check-input" name="cerita" id="cerita_tidak" value="Tidak" checked>
  ...
  <script>
    ...
    radioAnonymous.addEventListener('change', function() {
        if (this.checked) {
            ...
            inputAlamat.value = ''; // Mengosongkan nilai input
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const originalRow = dokumenContainer.innerHTML;

    addFileBtn.addEventListener("click", function() {
      const originalRowWithoutBtn = originalRow.replace('<button id="addFileBtn" class="btn btn-primary" type="button">+</button>', '');
      dokumenContainer.insertAdjacentHTML('beforeend', originalRowWithoutBtn);
      
      // Tambahkan tombol hapus di samping kolom "Choose File" berikutnya
      const inputGroups = dokumenContainer.querySelectorAll('.input-group');
      ...
      appendGroup.innerHTML = '<button class="btn btn-danger" type="button">-</button>';
      lastInputGroup.appendChild(appendGroup);

      // Tambahkan event listener untuk tombol hapus
      const deleteBtn = appendGroup.querySelector('.btn-danger');
      deleteBtn.addEventListener('click', function() {
        // Hapus kolom dan tombol hapus yang terkait
        dokumenContainer.removeChild(lastInputGroup);
        dokumenContainer.removeChild(appendGroup);
      });
    });
  });
</script>
